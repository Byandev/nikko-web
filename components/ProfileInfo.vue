        ...
        <div class="text-center relative border border-gray-300 rounded-lg overflow-hidden bg-white p-4" v-if="user">
                ...
                <template #actions>
                    <div class="flex justify-end space-x-2">
                        ...
                        <Button type="button" text="Upload" background="primary" foreground="white"
                            :is-loading="isLoading" :is-wide="false"
                            @click="() => uploadImage('AVATAR' as MediaType)"></Button>
                    </div>
                </template>
            </Modal>
            ...
            <Modal :modelValue="isBannerModalOpen" @update:modelValue="isBannerModalOpen = $event">
                ...
                <template #actions>
                    <div class="flex justify-end space-x-2">
                        <Button type="button" text="Cancel" background="white" foreground="black"
                            :is-loading="isLoading" :is-wide="false" @click="isBannerModalOpen = false"></Button>
                        <Button type="button" text="Upload" background="primary" foreground="white"
                            :is-loading="isLoading" :is-wide="false"
                            @click="() => uploadImage('BANNER' as MediaType)"></Button>
                    </div>
                </template>
            </Modal>
        </div>
