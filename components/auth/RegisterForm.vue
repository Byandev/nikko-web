...
<template>
  <div class="flex items-center justify-center p-10">
    <div class="flex flex-1 flex-col justify-center lg:flex-none">
      <div class="mx-auto w-full max-w-4xl bg-white rounded-2xl border-2 border-gray-200">
        <div class="flex flex-col lg:flex-row">
          <!-- Left Image Section -->
          <div class="relative flex items-center justify-center w-full mb-4 lg:mb-0">
            <img
            ...
            <div class="absolute text-center text-white px-4">
              ...
              <NuxtLink to="/" class=" text-white font-bold py-3 px-14 rounded-2xl border-2">
                LOG IN
              </NuxtLink>
            </div>
          </div>
          <!-- Right Form Section -->
          <div class="flex flex-col px-10 py-7 justify-center w-full lg:w-5/6">
                  ...
                  <form class="space-y-6" method="POST" @submit.prevent="submitForm">
                    ...
                    <div>
                      ...
                      <div class="mt-2">
                        ...
                        <span v-if="v$.password.$error" class="text-red-900 text-sm">{{ v$.password.$errors[0].$message
                          }}</span>
                      </div>
                    </div>
                    ...
                    <div>
                      <label class="flex items-center text-sm font-medium leading-6 text-gray-900" for="accept_policy">
