...
<template>
  <div
    ...
    <div class="w-4/12 divide-y p-4">
        <Button text="View Job" background="white" foreground="primary" class="ring-1 ring-primary w-full mb-2"
            @click="router.push(`/posts/${props.job.id}/details`)" type="button" />
        <Button text="All Proposal" background="white" foreground="primary" class="ring-1 ring-primary w-full mb-2"
            @click="router.push(`/posts/${props.job.id}/proposals`)" type="button" />
        <Button text="Invite Freelancers" background="white" foreground="primary" class="ring-1 ring-primary w-full mb-2"
            @click="router.push(`/posts/${props.job.id}/invite`)" type="button" />
        <Button text="Hired" background="white" foreground="primary" class="ring-1 ring-primary w-full mb-2"
