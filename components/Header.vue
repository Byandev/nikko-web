    ...
    <header class="flex flex-row justify-between items-center border-b-2 border-gray-200 text-white py-2 px-4 sm:px-16 bg-white">
        <div class="flex items-center">
           ...
           <div class="ml-5 border-l-2 pl-5">
                <NuxtLink :to="account?.type === 'FREELANCER'? '/find-work' : 'find-freelancer'" @click="closeDropdown" class="text-sm text-black">
        ...
        <div class="relative flex justify-end space-x-4 group">
            <template v-if="isAuthenticated">
                ...
                <div v-if="showDropdown" class="absolute right-0 mt-10 sm:mt-14 w-48 bg-white border rounded-lg shadow-lg z-50">
                    <NuxtLink :to="account?.type === 'FREELANCER' ? '/freelancer-dashboard' : '/client-dashboard'" @click="closeDropdown"
