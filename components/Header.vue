...
const { sendRequest: signOut } = useSubmit<
...
<template>
  ...
  >
    <div class="flex items-center">
      ...
      <div
        v-if="account?.type === 'FREELANCER'"
        class="hidden sm:block relative ml-5 text-sm"
      >
        <button
          @click="toggleDropdownMyContract"
      ...
      >
        ...
        >
          ...
          <NuxtLink
            to="/my-contract/active-contracts"
            @click="closeDropdown"
            class="block px-4 py-2 text-gray-800 hover:bg-gray-100"
          >
            All Contracts
    ...
    <div class="relative flex justify-end space-x-3 group">
      <template v-if="isAuthenticated">
        ...
        >
          <Icon icon="mdi:cart" width="26" height="26" class="text-primary" />
        </NuxtLink>
        <NuxtLink
          to="/chat"
          @click="closeDropdown"
      ...
      <template v-else>
        <NuxtLink
          to="/login"
          class="text-black font-bold py-2 px-2 sm:px-4 rounded"
        >
          Log in
        </NuxtLink>
        <NuxtLink
          to="/register"
          class="bg-primary rounded-full text-white font-bold py-2 px-2 sm:px-4"
        >
          Sign up
        </NuxtLink>
      </template>
