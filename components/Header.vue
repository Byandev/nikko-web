        ...
        <div class="flex items-center">
            ...
            <div v-if="account?.type === 'FREELANCER'" class="hidden sm:block relative ml-5 text-sm">
                ...
                <div v-if="showDropdownMyContract" class="absolute mt-2 w-48 bg-white border rounded-lg shadow-lg z-50">
                    ...
                    <NuxtLink to="/my-contract/pending-offers" @click="closeDropdown"
                        class="block px-4 py-2 text-gray-800 hover:bg-gray-100">
                        Pending Offers
                    </NuxtLink>
                    <NuxtLink to="/my-contract/active-jobs" @click="closeDropdown"
                        class="block px-4 py-2 text-gray-800 hover:bg-gray-100">
                        Active Jobs
                    </NuxtLink>
                    <NuxtLink to="/my-contract/completed-jobs" @click="closeDropdown"
                        class="block px-4 py-2 text-gray-800 hover:bg-gray-100">
                        Completed Jobs
                    </NuxtLink>
                </div>
