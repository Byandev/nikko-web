    ...
    <div class="my-8 lg:mx-auto mx-5">
        <div class="max-w-6xl grid grid-cols-1 gap-4 mt-5 mx-auto">
            <div class="flex flex-col gap-4">
                ...
                <form v-if="proposal?.data.id" @submit.prevent="">
                    ...
                    <div class="ring-1 ring-gray-300 rounded-md px-4 md:px-8 my-3 flex-1" v-if="!isLoading && proposal">
                        ...
                        <section class="pb-6 md:pb-8">
                            <Listbox :disabled="true" v-model="proposal.data.length"
                                ...
                                <div class="relative mt-1">
                                    <ListboxButton
                                        ...
                                        <span class="block truncate">
                                            <span v-if="!proposal.data.length">Select a duration</span>
                                            <span v-else>{{ _.startCase(proposal.data.length.toLowerCase()) }}</span>
                                        </span>
                                        <span
                    ...
                    <div class="ring-1 ring-gray-300 rounded-md px-4 md:px-8 my-3 flex-1" v-if="!isLoading && proposal">
                        ...
                        <section class="pb-6 md:pb-8">
                            <div class="flex flex-col gap-4 max-w-72">
                                ...
                                <input :disabled="true" type="number" id="hourly_rate" v-model="proposal.data.bid"
                    ...
                    <div class="ring-1 ring-gray-300 rounded-md px-4 md:px-8 my-3 flex-1" v-if="!isLoading && proposal">
                        ...
                        <section class="pb-6 md:pb-8">
                            <div class="flex flex-col gap-4 h-64">
                                ...
                                <textarea :disabled="true" id="cover_letter" v-model="proposal.data.cover_letter"
                        ...
                        <section class="pb-6 md:pb-8">
                            <div v-if="proposal.data.attachments">
                                <ul class="space-y-4">
                                    <li v-for="(image, index) in proposal.data.attachments" :key="index"
                    ...
                    <div class="flex flex-row gap-2 w-full justify-end">
                        <Button @click="router.back()" text="Close" type="button" background="primary" foreground="white" />
                    </div>
                </form>
            </div>
        </div>
