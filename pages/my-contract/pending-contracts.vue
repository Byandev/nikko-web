    ...
    <div class="max-w-6xl mx-auto mt-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg font-medium text-gray-900 mb-5">Pending Contracts</h3>
                ...
                <div class="space-y-5">
                    ...
                    <div v-else>
                        <p class="text-gray-600 text-base tracking-wider text-center">You have no pending contracts yet.
                        </p>
                    </div>
                </div>
            </div>
